//*********************************************************************
// Steven Salmons, continuing to build on C calls from 134/137
//
...
void TimerCode() {
  ...
  if( count % 300 == 0 ) cons_printf("k (press 'b' to return to GDB)\n");
...
int main() {
  ...
  outportb(PIC_MAS-00-------------0---0-00000000000000000000000000000000000---------------------;l    if(ch=='b')breakpoint();
