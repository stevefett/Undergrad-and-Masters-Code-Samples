...
#define PRINTER_SEMAPHORE 6
#define TTY1_INIT_DONE_SEMAPHORE 7
#define TTY2_INIT_DONE_SEMAPHORE 8
#define TTY1_OUTPUT_SPACE_AVAILABLE_SEMAPHORE 9
#define TTY2_OUTPUT_SPACE_AVAILABLE_SEMAPHORE 10
#define TTY1_INPUT_DATA_AVAILABLE_SEMAPHORE 11
#define TTY2_INPUT_DATA_AVAILABLE_SEMAPHORE 12

#define IO_REQUEST_MAILBOXID 0
#define IO_RESULT_MAILBOXID 1

#define FREE_BUFFER_MAILBOXID 5
#define CONSUMER_MAILBOXID 6
...
extern unsigned char globalBuffers[MAX_BUFFERS][BUFFER_SIZE];
extern bool DONE;
