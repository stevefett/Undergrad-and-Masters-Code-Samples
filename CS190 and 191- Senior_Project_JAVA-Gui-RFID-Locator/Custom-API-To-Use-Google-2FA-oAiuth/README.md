...
# Steven Salmons
# CS274 - Software Engineering Security
 
# Research Project - Collect and curate a library of git reeositories consisting of the most widely used exploits, workarounds, data corruption, etc. Git repositories, which are source code centric, help allow test failure debug.
# For process-only tool repositories, the author(s) are easier to contact for help.
